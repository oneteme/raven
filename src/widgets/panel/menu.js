...
const recordPill = createPill('#cc1111', createIconBtn('raven-record-button', createDiv('raven-record-icon'), () => recordEvent()), "Record");
export const modeMenu = createMenuContainer();

function createPill(color, contentEl, label) {
    ...
    const topHalf = createDiv('pill-top'),
        ...
        pillWrap = createDiv('pill-wrap', topHalf, shine, bottomHalf, contentSlot);
...
function createMenuContainer() {
    const menu = createDiv("menu-container", recordPill);
    return menu;
}